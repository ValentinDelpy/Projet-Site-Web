 ...
 * @author Soul
 */
@WebServlet(name = "AdminTableController", urlPatterns = {"/AdminTableController"})
public class AdminTableController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Customer> des = (ArrayList<Customer>) dao.allCustomers();
        request.setAttribute("listeClients", des);
